  ...
  return (
    <>
      <header className={cn(
        ...
        isHomepage ? "bg-background/80 backdrop-blur-sm" : "bg-background/80 backdrop-blur-sm"
      )}>
        <div className="container mx-auto flex h-20 items-center justify-between px-4 md:px-6">
          <Link href="/">
             <Image src="https://visionhub.pics/images/visionhub.png" alt="VisionHub Logo" width={180} height={45} className="w-[150px] md:w-[180px]" />
          </Link>
