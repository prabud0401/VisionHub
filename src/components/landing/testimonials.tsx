  ...
  return (
    <section id="about" className="py-20 lg:py-24">
      <div className="container mx-auto px-4 text-center">
        <h3 className="text-primary font-semibold tracking-wider uppercase">Wall of Love</h3>
        <h2 className="text-3xl font-bold mt-2 mb-12">Loved by Creators Worldwide</h2>
